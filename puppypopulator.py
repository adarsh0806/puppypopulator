...
#Add Shelters
shelter1 = Shelter(name = "Oakland Animal Services", address = "1101 29th Ave", city = "Oakland", state = "California", zipCode = "94601", website = "oaklandanimalservices.org", maximum_capacity = 100, current_occupancy = 75)
session.add(shelter1)

shelter2 = Shelter(name = "San Francisco SPCA Mission Adoption Center", address="250 Florida St", city="San Francisco", state="California", zipCode = "94103", website = "sfspca.org", maximum_capacity = 200, current_occupancy = 150)
session.add(shelter2)

shelter3 = Shelter(name = "Wonder Dog Rescue", address= "2926 16th Street", city = "San Francisco", state = "California" , zipCode = "94103", website = "http://wonderdogrescue.org", maximum_capacity = 150, current_occupancy = 85)
session.add(shelter3)

shelter4 = Shelter(name = "Humane Society of Alameda", address = "PO Box 1571" ,city = "Alameda" ,state = "California", zipCode = "94501", website = "hsalameda.org", maximum_capacity = 350, current_occupancy = 175)
session.add(shelter4)

shelter5 = Shelter(name = "Palo Alto Humane Society" ,address = "1149 Chestnut St." ,city = "Menlo Park", state = "California" ,zipCode = "94025", website = "paloaltohumane.org", maximum_capacity = 250, current_occupancy = 225)
session.add(shelter5)


#Add Adopters 
adopter1 = Adopter(name = 'Carl Sagan', puppy_id = randint(1,100))
session.add(adopter1)
adopter2 = Adopter(name = 'David Roth', puppy_id = randint(1,100))
session.add(adopter2)
adopter3 = Adopter(name = 'Bruce Wayne', puppy_id = randint(1,100))
session.add(adopter3)
adopter4 = Adopter(name = 'Felton James', puppy_id = randint(1,100))
...
for i,x in enumerate(male_names):
	...
	new_profile = Profile(url = 'www.example.com', desc = 'test', special_needs = 'test', puppy_id = randint(1,100))
